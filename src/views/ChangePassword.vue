  ...
  <div class="auth" :style="{ '--auth-bg': `url(${require('@/assets/auth.jpg')})` }">
    <div class="auth-inner">
      ...
      <section class="auth-panel">
        ...
        <main class="auth-card" role="main" aria-labelledby="changeTitle">
          <header class="cardc-hd">
            <h2 id="changeTitle" style="color:#2d2d2d;">비밀번호 재설정</h2>
          ...
          <form class="cardc-form" @submit.prevent="onSubmit" novalidate>
            ...
            <!-- 안내 문구 -->
            <p class="foot mt8 info-text">
              ⚠️ 비밀번호는 대문자, 숫자, 특수문자를 포함해야 합니다.<br />
              비밀번호 변경 후에는 다시 로그인해야 합니다.
            </p>
          </form>
        </main>
      </section>
